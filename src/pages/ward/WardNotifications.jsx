/**
 * Ward Notifications Page - Executive Jurisdiction Feed
 * High-fidelity interface for monitoring ward-level dispatches and officer directives.
 */
...
const WardNotifications = () => {
    ...
    if (loading && notifications.length === 0) return (
        <div className="d-flex flex-column justify-content-center align-items-center min-vh-100" style={{ backgroundColor: '#F8FAFC' }}>
            ...
            <p className="fw-black text-primary text-uppercase tracking-widest small" style={{ color: PRIMARY_COLOR }}>Synchronizing Nodal Feed...</p>
        </div>
    );

    return (
        <div className="ward-notifications-premium min-vh-100 pb-5" style={{ backgroundColor: '#F8FAFC' }}>
            <DashboardHeader
                portalName="PMC WARD EXECUTIVE"
                userName={localStorage.getItem('name') || "Ward Commissioner"}
                wardName="JURISDICTIONAL FEED"
                subtitle="Nodal alerts and executive dispatches for local oversight"
                icon={Compass}
                actions={
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <button onClick={markAllAsRead} className="btn btn-white bg-white rounded-pill px-4 py-2 shadow-sm fw-black extra-small tracking-widest d-flex align-items-center gap-2 border transition-all hover-up-tiny" style={{ color: PRIMARY_COLOR }}>
                            <CheckCheck size={16} /> RECONCILE ALL
                        </button>
                    </div>
                }
            />
                    ...
                    <div className="col-xl-3">
                        <div className="card border-0 shadow-premium rounded-4 bg-white p-4 p-lg-5 sticky-top" style={{ top: '2rem' }}>
                            <div className="d-flex align-items-center gap-3 mb-4">
                                ...
                                <h6 className="fw-black text-dark mb-0 uppercase tracking-widest extra-small opacity-40">Nodal Subscriptions</h6>
                            </div>

                            <div className="d-flex flex-column gap-2">
                                {[
                                    { id: 'all', label: 'Sector Broadcast', count: notifications.length, icon: Layers },
                                    { id: 'unread', label: 'Executive Alerts', count: unreadCount, icon: Bell, activeColor: '#173470' },
                                    { id: 'read', label: 'Log Archives', count: readCount, icon: ShieldCheck }
                                ].map(f => (
                                    <button
                                        key={f.id}
                            ...
                            <div className="mt-5 p-4 rounded-4 bg-light bg-opacity-50 border border-dashed text-center">
                                ...
                                <p className="extra-small fw-black text-muted uppercase tracking-widest mb-1 opacity-40">Link Stability</p>
                                <div className="extra-small fw-black text-success uppercase">Node Pulse: Nominal</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-9">
                        {filteredNotifications.length === 0 ? (
                            <div className="card border-0 shadow-premium rounded-4 bg-white p-5 text-center min-vh-50 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <h4 className="fw-black text-dark tracking-widest uppercase mb-1">Sector Clean</h4>
                                <p className="text-muted fw-bold small opacity-60">No pending executive alerts in the {filter} segment.</p>
                                {filter !== 'all' && (
                                                    ...
                                                    <div className="col">
                                                        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-2">
                                                            <div className="d-flex align-items-center gap-2">
                                                                ...
                                                                <h6 className="fw-black text-dark mb-0 uppercase tracking-tight small">{n.title || 'Official Nodal Update'}</h6>
                                                            </div>
                                                            <div className="d-flex align-items-center gap-3">
                                                            ...
                                                            <div className="d-flex align-items-center gap-3">
                                                                ...
                                                                {!n.isRead && (
                                                                    <div className="extra-small fw-black text-primary uppercase tracking-widest d-flex align-items-center gap-1" style={{ color: PRIMARY_COLOR }}>
                                                                        EXECUTIVE OVERSIGHT <ChevronRight size={14} />
                                                                    </div>
                                                                )}
                                                            </div>
                                                        )}
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                .ward-notifications-premium { font-family: 'Outfit', sans-serif; }
