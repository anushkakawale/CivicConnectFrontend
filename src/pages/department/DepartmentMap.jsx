...
const DepartmentMap = () => {
    ...
    const fetchMapComplaints = async () => {
        try {
            setLoading(true);
            const response = await apiService.departmentOfficer.getMyComplaints(0, 100);
            ...
            if (complaintsData.length > 0 && complaintsData[0].latitude && complaintsData[0].longitude) {
                setCenter([complaintsData[0].latitude, complaintsData[0].longitude]);
            }
        } catch (err) {
        ...
        <div className="container-fluid py-4">
            ...
            <div className="row mb-4">
                <div className="col-12">
                    ...
                    <p className="text-muted mb-0">Geographic view of assigned complaints</p>
                </div>
            </div>
                ...
                <div className="card-body">
                    <div className="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <div className="btn-group" role="group">
                            ...
                            <button
                                className={`btn btn-sm ${filterStatus === 'ASSIGNED' ? 'btn-info' : 'btn-outline-info'}`}
                                            ...
                                            >
                                                <Popup>
                                                    <div style={{ minWidth: '200px' }}>
                                                        <h6 className="fw-bold mb-2">#{complaint.complaintId} - {complaint.title}</h6>
                                                        <div className="mb-2">
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => navigate(`/department/complaints/${complaint.complaintId}`)}
                                                        >
                                                            View Details
                                                        </button>
                                                    </div>
            ...
            <div className="row mt-3">
                <div className="col-12">
                    <div className="card shadow-sm border-0">
                        <div className="card-body">
                            <h6 className="fw-bold mb-3">Map Legend</h6>
                            <div className="d-flex flex-wrap gap-4">
                                <div className="d-flex align-items-center gap-2">
                                    <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#0dcaf0', border: '2px solid white' }}></div>
                                    <span>Assigned</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                    <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#ffc107', border: '2px solid white' }}></div>
                                    <span>In Progress</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                    <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#198754', border: '2px solid white' }}></div>
                                    <span>Resolved</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                    <div style={{ width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#6c757d', border: '2px solid white' }}></div>
                                    <span>Closed</span>
                                </div>
                            </div>
                        </div>
